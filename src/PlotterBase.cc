...
PlotterBase::PlotterBase(TString _name):
	BaseAnalyser(_name),
  normalise(true),
  normalisation(1.),
  outfilename("PlotterBaseOut.root")
{
...
void PlotterBase::Init(Looper *l){
...
void PlotterBase::Term(Looper *l){
...
bool PlotterBase::AnalyseEvent(Looper *l){
  return fillHistograms(l);
}
...
void PlotterBase::fillHist(TString name, double val, Looper *l){
...
void PlotterBase::fillHist(TString name, float val, Looper *l){
  fillHist(name,double(val),l);
}

void PlotterBase::fillHist(TString name, int val, Looper *l){
  fillHist(name,double(val),l);
}

void PlotterBase::fillHist(TString name, bool val, Looper *l){
  fillHist(name,double(val),l);
}
