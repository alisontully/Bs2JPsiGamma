...
void AnalysisBranches::setInputBranches(Looper *l, TTree *tree){ 
	...
	tree->SetBranchAddress("gamgams_DiEBremMultiplicity", l->gamgams_DiEBremMultiplicity, &(l->b_gamgams_DiEBremMultiplicity));
	tree->SetBranchAddress("gamgams_DiEBremPE", l->gamgams_DiEBremPE, &(l->b_gamgams_DiEBremPE));
	tree->SetBranchAddress("gamgams_DiEBremPX", l->gamgams_DiEBremPX, &(l->b_gamgams_DiEBremPX));
	tree->SetBranchAddress("gamgams_DiEBremPY", l->gamgams_DiEBremPY, &(l->b_gamgams_DiEBremPY));
	tree->SetBranchAddress("gamgams_DiEBremPZ", l->gamgams_DiEBremPZ, &(l->b_gamgams_DiEBremPZ));
	...
	tree->SetBranchAddress("gamgams_eminus_DiEBremMultiplicity", l->gamgams_eminus_DiEBremMultiplicity, &(l->b_gamgams_eminus_DiEBremMultiplicity));
	tree->SetBranchAddress("gamgams_eminus_DiEBremPE", l->gamgams_eminus_DiEBremPE, &(l->b_gamgams_eminus_DiEBremPE));
	tree->SetBranchAddress("gamgams_eminus_DiEBremPX", l->gamgams_eminus_DiEBremPX, &(l->b_gamgams_eminus_DiEBremPX));
	tree->SetBranchAddress("gamgams_eminus_DiEBremPY", l->gamgams_eminus_DiEBremPY, &(l->b_gamgams_eminus_DiEBremPY));
	tree->SetBranchAddress("gamgams_eminus_DiEBremPZ", l->gamgams_eminus_DiEBremPZ, &(l->b_gamgams_eminus_DiEBremPZ));
	tree->SetBranchAddress("gamgams_eminus_StandaloneBremMultiplicity", l->gamgams_eminus_StandaloneBremMultiplicity, &(l->b_gamgams_eminus_StandaloneBremMultiplicity));
	tree->SetBranchAddress("gamgams_eplus_DiEBremMultiplicity", l->gamgams_eplus_DiEBremMultiplicity, &(l->b_gamgams_eplus_DiEBremMultiplicity));
	tree->SetBranchAddress("gamgams_eplus_DiEBremPE", l->gamgams_eplus_DiEBremPE, &(l->b_gamgams_eplus_DiEBremPE));
	tree->SetBranchAddress("gamgams_eplus_DiEBremPX", l->gamgams_eplus_DiEBremPX, &(l->b_gamgams_eplus_DiEBremPX));
	tree->SetBranchAddress("gamgams_eplus_DiEBremPY", l->gamgams_eplus_DiEBremPY, &(l->b_gamgams_eplus_DiEBremPY));
	tree->SetBranchAddress("gamgams_eplus_DiEBremPZ", l->gamgams_eplus_DiEBremPZ, &(l->b_gamgams_eplus_DiEBremPZ));
	tree->SetBranchAddress("gamgams_eplus_StandaloneBremMultiplicity", l->gamgams_eplus_StandaloneBremMultiplicity, &(l->b_gamgams_eplus_StandaloneBremMultiplicity));
...
void AnalysisBranches::initialiseVariables(Looper *l) {
	...
	l->gamgams_DiEBremMultiplicity           = new Double_t(0);
	l->gamgams_DiEBremPE                     = new Double_t(0);
	l->gamgams_DiEBremPX                     = new Double_t(0);
	l->gamgams_DiEBremPY                     = new Double_t(0);
	l->gamgams_DiEBremPZ                     = new Double_t(0);
	...
	l->gamgams_eminus_DiEBremMultiplicity    = new Double_t(0);
	l->gamgams_eminus_DiEBremPE              = new Double_t(0);
	l->gamgams_eminus_DiEBremPX              = new Double_t(0);
	l->gamgams_eminus_DiEBremPY              = new Double_t(0);
	l->gamgams_eminus_DiEBremPZ              = new Double_t(0);
	l->gamgams_eminus_StandaloneBremMultiplicity = new UInt_t(0);
	l->gamgams_eminus_StandaloneBremMultiplicityD = new Double_t(0);
	l->gamgams_eplus_DiEBremMultiplicity     = new Double_t(0);
	l->gamgams_eplus_DiEBremPE               = new Double_t(0);
	l->gamgams_eplus_DiEBremPX               = new Double_t(0);
	l->gamgams_eplus_DiEBremPY               = new Double_t(0);
	l->gamgams_eplus_DiEBremPZ               = new Double_t(0);
	l->gamgams_eplus_StandaloneBremMultiplicity = new UInt_t(0);
	l->gamgams_eplus_StandaloneBremMultiplicityD = new Double_t(0);
...
void AnalysisBranches::cleanVariables(Looper *l) {
	...
	delete l->gamgams_DiEBremMultiplicity;
	delete l->gamgams_DiEBremPE;
	delete l->gamgams_DiEBremPX;
	delete l->gamgams_DiEBremPY;
	delete l->gamgams_DiEBremPZ;
	...
	delete l->gamgams_Y;
	delete l->gamgams_Z;
	delete l->gamgams_eminus_DiEBremMultiplicity;
	delete l->gamgams_eminus_DiEBremPE;
	delete l->gamgams_eminus_DiEBremPX;
	delete l->gamgams_eminus_DiEBremPY;
	delete l->gamgams_eminus_DiEBremPZ;
	delete l->gamgams_eminus_StandaloneBremMultiplicity;
	delete l->gamgams_eminus_StandaloneBremMultiplicityD;
	delete l->gamgams_eplus_DiEBremMultiplicity;
	delete l->gamgams_eplus_DiEBremPE;
	delete l->gamgams_eplus_DiEBremPX;
	delete l->gamgams_eplus_DiEBremPY;
	delete l->gamgams_eplus_DiEBremPZ;
	delete l->gamgams_eplus_StandaloneBremMultiplicity;
	delete l->gamgams_eplus_StandaloneBremMultiplicityD;
...
void AnalysisBranches::setOutputBranches(Looper *l, TTree *tree){ 
	...
	tree->Branch("gamgams_DiEBremMultiplicity",l->gamgams_DiEBremMultiplicity);
	tree->Branch("gamgams_DiEBremPE",l->gamgams_DiEBremPE);
	tree->Branch("gamgams_DiEBremPX",l->gamgams_DiEBremPX);
	tree->Branch("gamgams_DiEBremPY",l->gamgams_DiEBremPY);
	tree->Branch("gamgams_DiEBremPZ",l->gamgams_DiEBremPZ);
	...
	tree->Branch("gamgams_eminus_DiEBremMultiplicity",l->gamgams_eminus_DiEBremMultiplicity);
	tree->Branch("gamgams_eminus_DiEBremPE",l->gamgams_eminus_DiEBremPE);
	tree->Branch("gamgams_eminus_DiEBremPX",l->gamgams_eminus_DiEBremPX);
	tree->Branch("gamgams_eminus_DiEBremPY",l->gamgams_eminus_DiEBremPY);
	tree->Branch("gamgams_eminus_DiEBremPZ",l->gamgams_eminus_DiEBremPZ);
	tree->Branch("gamgams_eminus_StandaloneBremMultiplicity",l->gamgams_eminus_StandaloneBremMultiplicity);
	tree->Branch("gamgams_eminus_StandaloneBremMultiplicityD",l->gamgams_eminus_StandaloneBremMultiplicityD);
	tree->Branch("gamgams_eplus_DiEBremMultiplicity",l->gamgams_eplus_DiEBremMultiplicity);
	tree->Branch("gamgams_eplus_DiEBremPE",l->gamgams_eplus_DiEBremPE);
	tree->Branch("gamgams_eplus_DiEBremPX",l->gamgams_eplus_DiEBremPX);
	tree->Branch("gamgams_eplus_DiEBremPY",l->gamgams_eplus_DiEBremPY);
	tree->Branch("gamgams_eplus_DiEBremPZ",l->gamgams_eplus_DiEBremPZ);
	tree->Branch("gamgams_eplus_StandaloneBremMultiplicity",l->gamgams_eplus_StandaloneBremMultiplicity);
	tree->Branch("gamgams_eplus_StandaloneBremMultiplicityD",l->gamgams_eplus_StandaloneBremMultiplicityD);
